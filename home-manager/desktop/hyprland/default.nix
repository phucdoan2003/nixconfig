{pkgs, ...}: {
  ...
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
            ...
            monitor=DP-6, 3840x2160@60.00Hz,0x0, 1
            monitor=HDMI-A-2, 1920x1080@60.00Hz, 3840x0, 1
          ...
          bezier = myBezier, 0.05, 0.9, 0.1, 1.05
           ...
           animation = workspaces, 1, 5, default
            ...
            bind = $mainMod, F, exec, hyprshot -m region --clipboard-only
      ...
      workspace=0,monitor:"HDMI-A-2",default:true
